import { defineWorkerModule, terminateWorker } from '../worker/sdf_worker.js'



const now = () => (self.performance || Date).now()

const initSDFGenerator = window.webgl_sdf_generator;

const mainThreadGenerator = /*#__PURE__*/ initSDFGenerator();
